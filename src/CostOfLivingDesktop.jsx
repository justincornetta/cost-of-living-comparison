        ...
        <section style={s.panel}>
          ...
          <div style={s.inputRow}>
            <div style={s.inputGroup}>
              ...
              <div style={s.inputWrap}><span style={s.inputPre}>$</span><input style={s.input} type="number" value={income.healthInsuranceMonthly} onChange={e => updateIncome('healthInsuranceMonthly', e.target.value)} /><span style={s.inputSuf}>/mo</span></div>
            </div>
            <div style={s.inputGroup}>
          ...
          <div style={s.computed}>
            ...
            {income.healthInsuranceMonthly > 0 && <div style={s.computedRow}><span>− Health Insurance</span><span>{fmt(income.healthInsuranceMonthly * 12)}</span></div>}
    ...
    const summary = (snap, label, tint) => (
      <div style={{ background: tint, borderRadius: 10, padding: 14 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '4px 12px', fontSize: 12, color: '#1A202C' }}>
          ...
          <span style={{ color: '#64748B' }}>Health Ins.</span><span style={{ fontWeight: 600 }}>{fmt((snap.income.healthInsuranceMonthly || 0) * 12)}</span>
